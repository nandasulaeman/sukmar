...
class FloorProduct extends BaseController
{
    protected $market;
    protected $product;
    ...
    {
        $floorProducts = $this->floorproduct->with(['product', 'floorPlan'])->findAll();
        dd($floorProducts);

        return view("page/management_floor_product", $floorProducts);
    }
