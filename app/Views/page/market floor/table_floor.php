...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title">Datatable Denah Pasar</h5>
            <a href="<?= base_url('markets_floor/create') ?>" class="btn btn-primary">
                Tambah
            </a>
        </div>
    </div>
                        ...
                        <td class="text-nowrap text-center">
                            <div class="d-flex justify-content-end">
                                <a title="Edit" class="btn btn-info btn-sm ms-1"
                                    href="<?= base_url('markets_floor/edit/' . $row->id) ?>">Edit</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="/markets">
                    <i class="bx bx-x d-block d-sm-none"></i>
                    <span class="d-none d-sm-block">Data Pasar</span>
                </a>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        $('.delete-floor').on('click', function () {
            ...
            var deleteUrl = '<?= base_url("markets_floor/delete/") ?>' + floorId;
