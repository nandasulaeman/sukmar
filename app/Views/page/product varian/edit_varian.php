...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Edit Data Varian Produk</h4>
    </div>
    <div class="card-body">
        <form class="form" method="post" action="<?= base_url('products_varian/update') ?>"
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_product" id="id_product">
                        ...
                        foreach ($product as $rows): ?>
                            <option value="<?= $rows->id; ?>" <?= ($varian->id_product == $rows->id) ? 'selected' : ''; ?>>
                                <?= $rows->name_product; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input id="name_varian" name="name_varian" type="text" class="form-control"
                        value="<?= $varian->name_varian; ?>" required />
                </div>
                <div class="form-group">
                    <label for="asset_url">Asset Url</label>
                    <input id="asset_url" name="asset_url" type="text" class="form-control"
                        value="<?= $varian->asset_url; ?>" required />
                </div>
                <div class="form-group">
                    <input type="hidden" name="imgold" value="<?= $varian->picture_varian; ?>" />
                    <label for="photo">Photo </label>
                    <div class="border preview-container" id="multipleImagePreview">
                        <div class="preview-item">
                            <div class="img-container">
                                <img src="<?= base_url('./img/' . $varian->picture_varian) ?>"
                                    alt="<?= $varian->picture_varian ?>">
                            </div>
                        </div>
                    </div>
                    <input type="file" class="form-control" id="multipleImageInput" name="picture_varian"
                        accept="image/*">
                </div>
